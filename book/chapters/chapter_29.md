...
The ultimate goal is algorithm recovery. A good circuit explanation must predict behavior on unseen inputs and be implementable as a compact program.
...
A valid algorithmic explanation must:
1. Predict behavior on held-out inputs
2. Be implementable as a compact program
