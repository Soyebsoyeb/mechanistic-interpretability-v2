...
Transformers learn from examples in their context. Understanding the mechanism requires controlled synthetic tasks where the underlying rule is known.
...
## Falsification
Falsified if claimed example-retrieval heads do not attend to examples during ICL.

## Exercises
- **Mathematical**: Formalize ICL as Bayesian inference.
- **Implementation**: Build ICL task with known linear rule.
- **Experimental**: Identify and validate example-retrieval heads.
